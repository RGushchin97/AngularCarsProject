...
export class CarsService {
  ...
  constructor() {
    this.cars = [];
    this.cars.push(new CarModel(1, 'BMW', 300000.75, new Date('1997-10-12'), Color.Black, true));
    this.cars.push(new CarModel(2, 'BMW', 3000123.25, new Date('1973-02-22'), Color.White, false));
    this.cars.push(new CarModel(3, 'Audi', 123124, new Date('1985-02-22'), Color.Orange, false));
    this.cars.push(new CarModel(4, 'BMW', 125521.1254, new Date('2002-02-01'), Color.Blue, false));
    //   new CarModel(id: 1, make: 'BMW', mileage: 300000.75, manufactureDate: new Date('1997-10-12'), color: Color.Black, forSale: true),
